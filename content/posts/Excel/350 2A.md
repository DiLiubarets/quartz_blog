...
Sub WAR_Pivot_To_Data()
    ...
    On Error Resume Next
    ThisWorkbook.Sheets("WAR" & monthName).Delete
    ThisWorkbook.Sheets("WAR_Pivot_" & monthName).Delete
    On Error GoTo 0
    Application.DisplayAlerts = True
    ...
    ' Copy PivotTable data
    wsSource.PivotTables("PivotTable4").TableRange2.Copy
    wsTarget.Range("A1").PasteSpecial Paste:=xlPasteAll
    ...
    ' Find column indexes dynamically
    Dim wpColIndex As Integer, totalMonthSPColIndex As Integer, typeOfWorkColIndex As Integer
    Dim headerRow As Range
    Set headerRow = wsTarget.Rows(1)
    ...
    For Each col In headerRow.Cells
        Select Case col.Value
            ...
            Case "Total month, SP"
                totalMonthSPColIndex = col.Column
            Case "Type of Work"
                typeOfWorkColIndex = col.Column
        End Select
    Next col

    ' Ensure required columns exist
    If wpColIndex = 0 Or totalMonthSPColIndex = 0 Or typeOfWorkColIndex = 0 Then
    ...
    wsPivot.Name = "WAR_Pivot_" & monthName
    ...
    ' Create Pivot Table
    Set pvtTable = pvtCache.CreatePivotTable(TableDestination:=wsPivot.Range("A1"), TableName:="WAR_PivotTable")
    ...
    Set slicerCache = wsPivot.Parent.SlicerCaches.Add2(pvtTable, "Type of Work")
    slicerCache.Slicers.Add wsPivot, , "Type_of_Work_Slicer", "Type of Work", wsPivot.Range("E2")

    MsgBox "Pivot Table with Slicer created successfully!", vbInformation
