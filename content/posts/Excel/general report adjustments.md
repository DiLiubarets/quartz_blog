...
Sub CombineSheets_withCol()
    ...
    If Not origEstCol Is Nothing And Not origEstHrsCol Is Nothing Then
        For i = 2 To lastRow
            combinedWs.Cells(i, origEstHrsCol.Column).Formula = "=" & combinedWs.Cells(i, origEstCol.Column).Address(False, False) & "/3600"
        Next i
    End If

    If Not remEstCol Is Nothing And Not remHrsCol Is Nothing Then
        For i = 2 To lastRow
            combinedWs.Cells(i, remHrsCol.Column).Formula = "=" & combinedWs.Cells(i, remEstCol.Column).Address(False, False) & "/3600"
        Next i
    End If

    If Not timeSpentCol Is Nothing And Not timeSpentHrsCol Is Nothing Then
        For i = 2 To lastRow
            combinedWs.Cells(i, timeSpentHrsCol.Column).Formula = "=" & combinedWs.Cells(i, timeSpentCol.Column).Address(False, False) & "/3600"
        Next i
    End If
